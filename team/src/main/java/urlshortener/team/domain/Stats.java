...
public class Stats {
    ...
    private Long time_last_redirection;
    ...
    public Stats(Long uptime_seconds, Long user_number, Long uri_number, Long click_number,
                 Long time_last_redirection, Long mem_used_mb, Long mem_available_mb) {
    ...
    public Long getTime_last_redirection() { return time_last_redirection; }
